                            ...
                            <div class="row mt-2">
                                <div class="col-md-2">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-item"><a href="<?php echo isset($_GET["proses"]) ? base_url("andon/pdf?proses="). $_GET["proses"] . "&model=". $_GET["model"] . "&machine=" . $_GET["machine"] . "&ps=" . $_GET["ps"] . "&date=" . $_GET["date"] . "&shift=" . $_GET["shift"] : base_url("andon/pdf"); ?>" target="_blank">PDF</a></li>
                                    </ul>
                                </div>
                                <div class="col-md-2">
