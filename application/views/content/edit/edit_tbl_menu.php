    ...
    <div class="box-body text-left">
      <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">  
            ...
            <input type="text" id="mother" name="mother" class="form-control" value="<?=$row->mother; ?>"/>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Parent Menu</label>
            <input type="text" id="parent" name="parent" class="form-control" value="<?=$row->parent; ?>"/>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" id="nav" name="nav" class="form-control" value="<?=$row->nav; ?>"/>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            <div class="form-group">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Tabel Master</label>
            <input type="text" id="tabel" name="tabel" class="form-control" value="<?=$row->tabel; ?>"/>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Order Menu</label>
            <input type="number" id="orders" name="orders" class="form-control" value="<?=$row->orders; ?>"/>
          </div>
        </div>
    </div>
</div>
