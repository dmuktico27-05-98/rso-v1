  ...
  <?=form_open('mastercrud/edit_json', 'id="mydata1" ');
   ...
   <div class="box-body text-left">
        <div class="form-group">
          ...
          <input id="shop_name" type="text" name="shop_name" class="form-control" value="<?=$row->shop_name; ?>"/>
        </div>
        <div class="form-group">
        <label for="exampleInputEmail1">Cost Center</label>
          <input id="cost_center" type="text" name="cost_center" class="form-control" value="<?=$row->cost_center; ?>"/>
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">GR Code</label>
          <input id="gr_code" type="text" name="gr_code" class="form-control" value="<?=$row->gr_code; ?>">
        </div>
  </div>
  <?php } ?>
       <!-- /.box-body -->
