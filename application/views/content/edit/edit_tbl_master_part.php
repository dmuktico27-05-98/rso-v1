    ...
    <div class="box-body text-left">
      <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">  
            ...
            <input type="text" id="machine" name="machine" class="form-control" value="<?=$row->machine; ?>"/>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="form-group">
            <label for="exampleInputEmail1">Patan</label>            
            <input type="text" id="patan" name="patan" class="form-control" value="<?=$row->patan; ?>"/>
          </div>
        </div>
    </div>
</div>
