      ...
      <div id="form" class="container-fluid" style="margin-top: 15px;padding: 5px;">
                <div class="box box-header no-border">
                      ...
                      <!-- /.box-header -->
                      <!-- form start -->
      <?=form_open_multipart('mastercrud/add_json', 'id="mydata"'); ?>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">                                
                <div class="form-group">
                  ...
                  <input id="title" type="text" name="title" class="form-control" title="Input title...">
                </div>                              
                <div class="form-group">
                  <label for="exampleInputEmail1">Detail</label>                  
                  <input id="detail" type="text" name="detail" class="form-control" title="Input detail...">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Owner</label>                  
                  <input id="owner" type="text" name="owner" class="form-control" title="Input owner...">
                </div> 
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">                                                                          
                <div class="form-group">
                  <label for="exampleInputEmail1">Version</label>                  
                  <input id="version" type="text" name="version" class="form-control" title="Input version...">
                </div>
                <div class="form-group">
                  <label for="exampeInpultEmail1">Image Logo (jpg/png/gif) max 2 MB</label>
