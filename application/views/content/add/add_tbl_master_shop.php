                        ...
                        <input id="table" type="hidden" name="table" value="<?=$table;?>"/>
                            <div class="box-body">                               
                                <div class="form-group">
                                  ...
                                  <input id="shop_name" type="text" name="shop_name" class="form-control" title="Input shop_name...">
                                </div>
                                    <div class="form-group">
                                    <label for="exampleInputEmail1">Cost Center</label>
                                    <input id="cost_center" type="text" name="cost_center" class="form-control" title="Input cost_center...">
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">GR Code</label>
                                    <input id="gr_code" type="text" name="gr_code" class="form-control" title="Input gr_code...">
                                  </div>
                              </div>
                          <!-- /.box-body -->
