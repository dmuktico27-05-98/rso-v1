...
<div class="page" style="margin-bottom: -30px;">
		...
		<table style="width: 100%;margin:0px;">
			<tr>
				...
				<td style="text-align: left;font-weight: bold;vertical-align: middle;">
					PT. ASTRA DAIHATSU MOTOR <br>LOGISTIC <?=strtoupper($shop_name);?>
				</td>
			</tr>
		</table>
		</td>
		...
		<td style="border:1px solid #444;vertical-align: middle;text-align: center;width: 23%">
			...
			<tr>
				...
				<td style="text-align: center;font-size: 10px;font-weight: bold;">
					FOR <?php if($i==1){ echo"LOGISTIC"; }else{ echo strtoupper($shop_name); }?><br>
					TO LPB
				</td>
			</tr>
		</table>
	...
	<td class="center" style="width: 5%;">Qty(pcs)</td>
	<td class="center" style="width: 5%;">Check Log</td>
	</tr>

	<?php $y=1; foreach ($data_hrp as $value) { ?>
		<tr class="list_row">
