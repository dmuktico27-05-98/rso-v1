...
<body>
  ...
  <table style="width: 100%;height:100%;border:1px solid #444;">
    <tr>
      <td style="margin:0px;">
        <table style="width: 100%;height:100%;text-align: center;margin:4px">
          <tr>
            <td  style="padding:0px;margin:0px">  
            <span style="font-size:20px;padding: 0px"><b>SCAN HERE!</b></span><br/>
              <img src="<?=base_url('assets/lte/mpdf60/qrcode/image.php?msg='.urlencode($key->qr_code).'&amp;err='.urlencode('Q'));?>" style="width:75px;height: 75px;text-align: center;padding:4px;">
