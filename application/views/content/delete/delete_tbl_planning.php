      ...
      <div id="form4" class="container-fluid" style="margin-top: 15px;padding: 5px;">
                <div class="box box-header no-border">
                      ...
                      <!-- /.box-header -->
                      <!-- form start -->
      <?=form_open('mastercrud/delete_all', 'id="mydata"'); ?>
        <input id="table" type="hidden" name="table" value="<?=$table;?>"/>
        <div class="box-body">                               
            <div class="form-group">
              <label for="exampleInputEmail1">Upload. Date (hanya yang belum digenerate lot)</label>
              <input id="upload_date" type="text" class="form-control date" name="upload_date" class="form-control">
            </div>                        
          </div>
    <!-- /.box-body -->
